...
- [ ] **Phase 07: Locale Hardening & Splash Auto-Selection Race** — Force Magicline to de-DE and gate splash on register-selected, not cash-register-ready.
...
**Plans:** 6 plans
- [ ] 07-01-PLAN.md — Wave 0: LOCALE_STRINGS.de table + live-kiosk DOM survey
...
|-------|----------------|--------|-----------|
| 07. Locale Hardening & Splash Race | 0/6 | Planned | - |

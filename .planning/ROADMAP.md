...
**Plans:** 2 plans
- [ ] 08-01-PLAN.md — Main-process: magiclineView.exists(), closeAdminMenu helper, toggle, reload fix, PIN change IPC
...
| 08. Admin Menu Polish & Reload Fix | 0/2 | Planning complete | - |

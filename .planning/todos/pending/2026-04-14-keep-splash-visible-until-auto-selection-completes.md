...
4. **Edge cases to handle:**
   ...
   - ~~**NFC routing during the gap.**~~ **N/A under NFC descope (2026-04-14, quick 260414-eu9):** the badge-routing arbiter is gone. HID keystrokes during the auto-selection window simply land in whatever has focus (usually the Magicline input being animated through the click chain), which is harmless because nothing parses them.

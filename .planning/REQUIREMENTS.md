...
REQ-IDs will be mapped to phases by the `gsd-roadmapper` agent in Step 10. Phase numbering continues from **phase 07** (v1.0 ended at phase 06; v1.0 phase directories remain in `.planning/phases/` because the previous milestone was reconciled manually rather than via `/gsd-complete-milestone`).

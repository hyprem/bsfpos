...
- [x] 05-03-update-gate-session-hook-PLAN.md — sessionReset onPostReset hook + updateGate.js safe-window module (ADMIN-07)
- [x] 05-04-main-orchestration-PLAN.md — autoUpdater.js + Ctrl+Shift+F12 wiring + admin IPC handlers + health watchdog (ADMIN-01, ADMIN-02, ADMIN-06, ADMIN-07, ADMIN-08)
- [x] 05-05-host-ui-PLAN.md — host.html/css/js admin menu, update config, updating cover, PIN lockout, error variants (ADMIN-01, ADMIN-02, ADMIN-03, ADMIN-08, BRAND-01, BRAND-02, BRAND-03)
- [x] 05-06-log-migration-verification-PLAN.md — log.audit migration across phase 1-4 modules, touch-target audit, phase 5 acceptance test, VERIFICATION.md (ADMIN-04, ADMIN-05, BRAND-02)
**UI hint**: yes

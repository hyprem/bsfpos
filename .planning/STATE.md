...
- **Progress:** [██████████] 100%
- **Audit posture:** `tech_debt` (no critical blockers; 19 physical verification items in next-kiosk-visit batch)
...
**Next kiosk visit batch (19 items, all with automated backstops):**
...
- Phase 4: 13 items — NFC-01..06 + IDLE-01..07 (IDLE-05 must run LAST, destructive)
- Phase 6: 1 item — 5-cycle welcome-loop smoke check
